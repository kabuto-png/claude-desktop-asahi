#!/bin/bash
# Create the Fedora Asahi build script

echo "Creating fedora_asahi_build_script.sh..."

cat > fedora_asahi_build_script.sh << 'EOF'
#!/bin/bash
set -e
...
echo "✅ Created fedora_asahi_build_script.sh"