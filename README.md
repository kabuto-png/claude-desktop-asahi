...
[![ShellCheck](https://github.com/kabuto-png/claude-desktop-asahi/actions/workflows/lint.yml/badge.svg)](https://github.com/kabuto-png/claude-desktop-asahi/actions/workflows/lint.yml)
...
```bash
curl -fsSL https://raw.githubusercontent.com/kabuto-png/claude-desktop-asahi/main/install.sh | bash
```
...
# Or manually
git clone https://github.com/kabuto-png/claude-desktop-asahi.git
cd claude-desktop-asahi/aur
makepkg -si
```
